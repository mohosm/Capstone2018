...
isViz = <div className="viz">{f} {this.state.legend}</div>
      ...
      f=menuItems.map(c=>{
        ...
        <Link onClick={this.addContent} onMouseOver={this.menuHighlight} onMouseLeave={this.menuHighlight} to={c.where}><img src={c.img} className="thePho" /><p>{c.title}</p></Link>
...
// Forward-backward buttons
    ...
    if(this.props.pageData.id !== 1){
      if(this.props.pageData.id !==13 && this.props.pageData.id !==16 && this.props.pageData.id !==22 && this.props.pageData.id !==27){
